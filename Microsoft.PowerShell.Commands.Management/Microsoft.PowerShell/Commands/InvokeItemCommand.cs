...
{
	[Cmdlet("Invoke", "Item", DefaultParameterSetName="Path", SupportsShouldProcess=true, SupportsTransactions=true, HelpUri="http://go.microsoft.com/fwlink/?LinkID=113345")]
	public class InvokeItemCommand : CoreCommandWithCredentialsBase
	{
		...
		internal override object GetDynamicParameters(CmdletProviderContext context)
		{
			...
			{
				return base.InvokeProvider.Item.InvokeItemDynamicParameters(".", context);
			}
			else
			{
				return base.InvokeProvider.Item.InvokeItemDynamicParameters(this.Path[0], context);
			}
		}
