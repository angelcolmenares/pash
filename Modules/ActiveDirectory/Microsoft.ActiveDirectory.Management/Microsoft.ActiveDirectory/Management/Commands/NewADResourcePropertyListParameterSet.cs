...
{
	public class NewADResourcePropertyListParameterSet : ADParameterSet
	{
		[Parameter]
		...
		[Parameter]
		[ValidateNotNull]
		public ADResourcePropertyList Instance
		{
			get
			{
				return base["Instance"] as ADResourcePropertyList;
			}
			set
			{
				base["Instance"] = value;
		...
		public NewADResourcePropertyListParameterSet()
		{
		}
	}
}