...
{
	public class GetADComputerParameterSet : ADParameterSet
	{
		[Parameter]
		...
		[Parameter(Mandatory=true, ParameterSetName="Filter", HelpMessageBaseName="Microsoft.ActiveDirectory.Management", HelpMessageResourceId="ADComputerFilterHM")]
		[TransformFilter]
		[ValidateNotNullOrEmpty]
		...
		public GetADComputerParameterSet()
		{
		}
	}
}