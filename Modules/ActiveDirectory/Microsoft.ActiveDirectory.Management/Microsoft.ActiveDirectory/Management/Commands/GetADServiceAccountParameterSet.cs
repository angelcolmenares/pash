...
{
	public class GetADServiceAccountParameterSet : ADParameterSet
	{
		[Parameter]
		...
		[Parameter(Mandatory=true, ParameterSetName="Filter", HelpMessageBaseName="Microsoft.ActiveDirectory.Management", HelpMessageResourceId="ADServiceAccountFilterHM")]
		[TransformFilter]
		[ValidateNotNullOrEmpty]
		...
		public GetADServiceAccountParameterSet()
		{
		}
	}
}