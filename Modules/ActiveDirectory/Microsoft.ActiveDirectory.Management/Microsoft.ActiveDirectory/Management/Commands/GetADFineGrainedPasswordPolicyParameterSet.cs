...
{
	public class GetADFineGrainedPasswordPolicyParameterSet : ADParameterSet
	{
		[Parameter]
		...
		[Parameter(Mandatory=true, ParameterSetName="Filter", HelpMessageBaseName="Microsoft.ActiveDirectory.Management", HelpMessageResourceId="ADFineGrainedPPFilterHM")]
		[TransformFilter]
		[ValidateNotNullOrEmpty]
		...
		public GetADFineGrainedPasswordPolicyParameterSet()
		{
		}
	}
}