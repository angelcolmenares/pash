...
{
	public class GetADObjectParameterSet : ADParameterSet
	{
		[Parameter]
		...
		[Parameter(Mandatory=true, ParameterSetName="Filter", HelpMessageBaseName="Microsoft.ActiveDirectory.Management", HelpMessageResourceId="ADObjectFilterHM")]
		[TransformFilter]
		[ValidateNotNullOrEmpty]
		...
		public GetADObjectParameterSet()
		{
		}
	}
}