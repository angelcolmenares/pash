...
{
	public class SetADReplicationSiteLinkBridgeParameterSet : ADParameterSet
	{
		...
		public Hashtable SiteLinksIncluded
		{
			get
			{
				return base["SiteLinksIncluded"] as Hashtable;
			}
			set
			{
				base["SiteLinksIncluded"] = new ADMultivalueHashtableParameter<string>(value);
			}
		}

		public SetADReplicationSiteLinkBridgeParameterSet()
		{
		}
	}
}