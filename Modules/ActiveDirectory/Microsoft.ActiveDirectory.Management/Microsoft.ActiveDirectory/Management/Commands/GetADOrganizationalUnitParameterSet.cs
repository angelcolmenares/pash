...
{
	public class GetADOrganizationalUnitParameterSet : ADParameterSet
	{
		[Parameter]
		...
		[Parameter(Mandatory=true, ParameterSetName="Filter", HelpMessageBaseName="Microsoft.ActiveDirectory.Management", HelpMessageResourceId="ADOUFilterHM")]
		[TransformFilter]
		[ValidateNotNullOrEmpty]
		...
		public GetADOrganizationalUnitParameterSet()
		{
		}
	}
}