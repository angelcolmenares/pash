...
{
    Write-Verbose "PSCX prepending format data $PSScriptRoot/Pscx.FileSystem.Format.ps1xml."
    Update-FormatData -PrependPath "$PSScriptRoot/Pscx.FileSystem.Format.ps1xml"
