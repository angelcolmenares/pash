namespace System.Data.Services.Internal
{
    ...
    internal sealed class ExpandedWrapper<TExpandedElement, TProperty0, TProperty1, TProperty2, TProperty3, TProperty4, TProperty5, TProperty6, TProperty7, TProperty8, TProperty9, TProperty10, TProperty11> : ExpandedWrapper<TExpandedElement>
    {
        protected override object InternalGetExpandedPropertyValue(int nameIndex)
        {
            ...
            if (nameIndex == 10)
            {
                return this.ProjectedProperty10;
            }
            if (nameIndex != 11)
            {
                throw Error.NotSupported();
            }
            return this.ProjectedProperty11;
        }
