...
namespace Microsoft.Data.Edm.Library.Internal
{
	internal class BadDecimalTypeReference : EdmDecimalTypeReference, IEdmCheckable
	{
		...
		public BadDecimalTypeReference(string qualifiedName, bool isNullable, IEnumerable<EdmError> errors) : base(new BadPrimitiveType(qualifiedName, (EdmPrimitiveTypeKind)6, errors), isNullable, null, null)
		{
			this.errors = errors;
		}
