...
namespace Microsoft.Data.Edm.Library.Internal
{
	internal class BadPrimitiveTypeReference : EdmPrimitiveTypeReference, IEdmCheckable
	{
		...
		public BadPrimitiveTypeReference(string qualifiedName, bool isNullable, IEnumerable<EdmError> errors) : base(new BadPrimitiveType(qualifiedName, 0, errors), isNullable)
		{
			this.errors = errors;
		}
