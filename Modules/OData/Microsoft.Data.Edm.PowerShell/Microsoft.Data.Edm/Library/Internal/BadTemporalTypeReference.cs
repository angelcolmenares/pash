...
namespace Microsoft.Data.Edm.Library.Internal
{
	internal class BadTemporalTypeReference : EdmTemporalTypeReference, IEdmCheckable
	{
		...
		public BadTemporalTypeReference(string qualifiedName, bool isNullable, IEnumerable<EdmError> errors) : base(new BadPrimitiveType(qualifiedName, 0, errors), isNullable, null)
		{
			this.errors = errors;
		}
