...
namespace Microsoft.Data.Edm
{
	internal sealed class EntityRes
	{
		...
		internal EntityRes()
		{
			this.resources = new ResourceManager("Microsoft.Data.Edm", this.GetType().Assembly);
		}
		...
		private static EntityRes GetLoader()
		{
			...
			{
				EntityRes entityRe = new EntityRes();
				Interlocked.CompareExchange<EntityRes>(ref EntityRes.loader, entityRe, null);
			}
		...
		public static object GetObject(string name)
		{
			...
			if (loader != null)
			{
				return loader.resources.GetObject(name, EntityRes.Culture);
			}
			else
			{
				return null;
