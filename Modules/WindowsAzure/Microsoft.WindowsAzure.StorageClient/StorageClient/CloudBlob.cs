...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    using Protocol;
    using Tasks;
    using TaskSequence = System.Collections.Generic.IEnumerable<Tasks.IStorageTask>;
    ...
    public class CloudBlob : IListBlobItem
    {
        ...
        /// <param name="options">An object that specifies any additional options for the request.</param>
        /// <returns>A <see cref="TaskSequence"/> that uploads the blob.</returns>
		internal StorageTask<NullTaskReturn> UploadFullBlobWithRetryImpl(Stream source, BlobRequestOptions options)
        {
		...
		internal StorageTask<NullTaskReturn> UploadBlockWithRetry(Stream source, string blockId, string contentMD5, BlobRequestOptions options)
        {
        ...
        {
            // Retrieve the stream
            var requestStreamTask = request.GetRequestStreamAsyncEx();
