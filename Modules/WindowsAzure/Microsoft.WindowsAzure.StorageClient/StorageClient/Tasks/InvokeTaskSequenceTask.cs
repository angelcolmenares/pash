...
namespace Microsoft.WindowsAzure.StorageClient.Tasks
{
	...
	internal class InvokeTaskSequenceTask<T> : StorageTask<T>
    {
        /// <summary>
        ...
        /// </summary>
        private IStorageTask currentTask;
        ...
        protected override void AbortInternal()
        {
            ...
            this.aborting = true;
            IStorageTask task = this.currentTask;
            if (task != null)
            {
                task.Abort();
            }
        ...
        protected override void ExecuteInternal()
        {
            ...
            IEnumerator<IStorageTask> en = sequence.GetEnumerator();
        ...
        private void ExecuteTaskSequence(IEnumerator<IStorageTask> taskList, bool completedSynchronously)
        {
        ...
        Run:
            ...
            IStorageTask task = taskList.Current;
