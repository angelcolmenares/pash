...
namespace Microsoft.WindowsAzure.StorageClient.Tasks
{
    ...
    internal static class WebRequestExtensions
    {
        ...
        [DebuggerNonUserCode]
		internal static StorageTask<WebResponse> GetResponseAsyncWithTimeout(this WebRequest req, CloudQueueClient service, TimeSpan? timeout)
        {
        ...
        [DebuggerNonUserCode]
		internal static StorageTask<Stream> GetRequestStreamAsyncEx(this WebRequest req)
        {
        ...
        /// <returns>A task that yields the response.</returns>
        [DebuggerNonUserCode]
		private static StorageTask<WebResponse> GetResponseAsyncEx(this WebRequest req, CloudBlobClient service)
        {
        ...
        /// <returns>A task that yields the response.</returns>
        [DebuggerNonUserCode]
		private static StorageTask<WebResponse> GetResponseAsyncEx(this WebRequest req, CloudQueueClient service)
        {
            return new APMTask<WebResponse>(
                req.BeginGetResponse,
                (asyncresult) => service.EndGetResponse(asyncresult, req),
