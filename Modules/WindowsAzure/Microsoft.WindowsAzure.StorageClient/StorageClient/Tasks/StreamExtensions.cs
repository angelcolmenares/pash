...
namespace Microsoft.WindowsAzure.StorageClient.Tasks
{
    ...
    using TaskSequence = System.Collections.Generic.IEnumerable<IStorageTask>;
    ...
    internal static class StreamExtensions
    {
        ...
        [DebuggerNonUserCode]
		internal static StorageTask<int> ReadAsyncEx(this Stream stream, byte[] buffer, int offset, int count)
        {
        ...
        [DebuggerNonUserCode]
		internal static StorageTask<NullTaskReturn> WriteAsyncEx(this Stream stream, byte[] buffer, int offset, int count)
        {
            return new APMTask(
        ...
        internal static TaskSequence WriteTo(this Stream stream, Stream toStream)
        {
            ...
            do
            {
                ...
                var readTask = stream.ReadAsyncEx(buffer, 0, buffer.Length);
                yield return readTask;
                readCount = readTask.Result;

                var writeTask = toStream.WriteAsyncEx(buffer, 0, readCount);
