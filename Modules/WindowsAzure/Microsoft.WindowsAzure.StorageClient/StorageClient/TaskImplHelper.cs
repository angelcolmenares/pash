...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    using Tasks;
    using TaskSequence = System.Collections.Generic.IEnumerable<Microsoft.WindowsAzure.StorageClient.Tasks.IStorageTask>;
    ...
    internal static class TaskImplHelper
    {
        ...
        [DebuggerNonUserCode]
		internal static StorageTask<T> GetRetryableAsyncTask<T>(Func<Action<T>, TaskSequence> impl, RetryPolicy policy)
        {
            CommonUtils.AssertNotNull("impl", impl);
            CommonUtils.AssertNotNull("policy", policy);
        ...
        /// <returns>The retryable task.</returns>
        [DebuggerNonUserCode]
		internal static StorageTask<NullTaskReturn> GetRetryableAsyncTask(Func<TaskSequence> impl, RetryPolicy policy)
        {
            CommonUtils.AssertNotNull("impl", impl);
            CommonUtils.AssertNotNull("policy", policy);
