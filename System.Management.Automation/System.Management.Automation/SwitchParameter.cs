namespace System.Management.Automation
{
    ...
    public struct SwitchParameter
    {
        ...
        public static bool operator ==(SwitchParameter first, int second)
        {
            var ssecond = second == 1 ? true : false;
            return first.Equals(ssecond);
        }
        ...
        public static bool operator ==(int first, SwitchParameter second)
        {
            var ffirst = first == 1 ? true : false;
            return ffirst.Equals((bool)second);
        }
