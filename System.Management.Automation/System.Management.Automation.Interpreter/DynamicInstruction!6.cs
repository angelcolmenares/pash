namespace System.Management.Automation.Interpreter
{
    ...
    internal class DynamicInstruction<T0, T1, T2, T3, T4, TRet> : Instruction
    {
        ...
        {
            frame.Data[frame.StackIndex - 5] = this._site.Target(this._site, (T0) frame.Data[frame.StackIndex - 5], (T1) frame.Data[frame.StackIndex - 4], (T2) frame.Data[frame.StackIndex - 3], (T3) frame.Data[frame.StackIndex - 2], (T4) frame.Data[frame.StackIndex - 1]);
            frame.StackIndex -= 4;
            return 1;
        }
