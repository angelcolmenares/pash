namespace System.Management.Automation.Interpreter
{
    ...
    internal class DynamicInstruction<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TRet> : Instruction
    {
        ...
        {
            frame.Data[frame.StackIndex - 15] = this._site.Target(this._site, (T0) frame.Data[frame.StackIndex - 15], (T1) frame.Data[frame.StackIndex - 14], (T2) frame.Data[frame.StackIndex - 13], (T3) frame.Data[frame.StackIndex - 12], (T4) frame.Data[frame.StackIndex - 11], (T5) frame.Data[frame.StackIndex - 10], (T6) frame.Data[frame.StackIndex - 9], (T7) frame.Data[frame.StackIndex - 8], (T8) frame.Data[frame.StackIndex - 7], (T9) frame.Data[frame.StackIndex - 6], (T10) frame.Data[frame.StackIndex - 5], (T11) frame.Data[frame.StackIndex - 4], (T12) frame.Data[frame.StackIndex - 3], (T13) frame.Data[frame.StackIndex - 2], (T14) frame.Data[frame.StackIndex - 1]);
            frame.StackIndex -= 14;
            return 1;
        }
