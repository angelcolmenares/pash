namespace System.Management.Automation.Interpreter
{
    ...
    internal class DynamicInstruction<T0, T1, T2, T3, T4, T5, TRet> : Instruction
    {
        ...
        {
            frame.Data[frame.StackIndex - 6] = this._site.Target(this._site, (T0) frame.Data[frame.StackIndex - 6], (T1) frame.Data[frame.StackIndex - 5], (T2) frame.Data[frame.StackIndex - 4], (T3) frame.Data[frame.StackIndex - 3], (T4) frame.Data[frame.StackIndex - 2], (T5) frame.Data[frame.StackIndex - 1]);
            frame.StackIndex -= 5;
            return 1;
        }
