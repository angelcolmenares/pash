			...
			else
			{
				if (methodName != null)
				{
					...
					try
					{
						...
						int num = this.scope.GetSecuredIWbemServicesHandler(this.scope.GetIWbemServices()).ExecMethod_(this.path.RelativePath, methodName, invokeMethodOption1.Flags, invokeMethodOption1.GetContext(), wbemClassObjectFreeThreaded1, ref wbemClassObjectFreeThreaded2, IntPtr.Zero);
						if (num < 0)
						{
							if (((long)num & (long)-4096) != (long)-2147217408)
							{
