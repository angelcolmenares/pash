...
namespace System.DirectoryServices
{
	...
	{
		public ExtendedRightAccessRule(IdentityReference identity, AccessControlType type) : base(identity, 0x100, type, Guid.Empty, false, 0, 0, Guid.Empty)
		{
		}

		public ExtendedRightAccessRule(IdentityReference identity, AccessControlType type, Guid extendedRightType) : base(identity, 0x100, type, extendedRightType, false, 0, 0, Guid.Empty)
		{
		}
