...
namespace SharpCompress.Archive.Zip
{
    public class ZipArchive : AbstractWritableArchive<ZipArchiveEntry, ZipVolume>
    {
                ...
                if (h != null)
                {
                    switch (h.ZipHeaderType)
                    {
                        case ZipHeaderType.DirectoryEntry:
                            {
                                yield return new ZipArchiveEntry(i++, this,
		...
		protected override ZipArchiveEntry CreateEntry(int index, string filePath, Stream source, long size, DateTime? modified)
        {
            return new ZipWritableArchiveEntry(index, this, source, filePath, size, modified);
        }
